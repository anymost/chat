 This a project was bootstrapped with [Create React App](https://github.com/facebookincubator/create-react-app).
...
[`src/login.js`](src/index.js) with a call to `serviceWorkerRegistration.unregister()`.
